...
init_bonddim=256
sweep=20
n=[256,320,384,448,512]
j_coupling=-1.
omega=0.
hmaxs=[2*exp(1)]
#hmaxs=LinRange(2*exp(1)-0.1,2*exp(1)+0.1,10)
#hmaxs=[1.,1.5,2.,2.5,3.,3.5,4.,4.5,5.,5.5,6.,6.5,7.,7.5]
...
for j=1:length(n)
        ...
        for k=1:length(hmaxs)
                #name file
                namefile="data/check_the_2nn_phase_transition/051222/test_periodic_$(n[j])_l_$(hmaxs[k])_h_$(ndata)_n.npz"
